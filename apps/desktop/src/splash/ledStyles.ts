...
export const LED_STYLES: Record<BootPhaseState, LedStyle> = {
  ...
  waiting: { className: "bg-dbzs-muted/60", animationClassName: "dbzs-animate-status-pulse", label: "Wartet" },
  running: { className: "bg-dbzs-cyan", animationClassName: "dbzs-animate-status-pulse", label: "Läuft" },
  ...
  retrying: { className: "bg-dbzs-amber", animationClassName: "dbzs-animate-status-pulse", label: "Wiederholung" },
