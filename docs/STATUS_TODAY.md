...
- Plan 15 Agentic Model Fleet Integration ist auf Branch `codex/agentic-model-fleet-integration` gestartet:
  ...
  bounded `llama.cpp`-Probe-Preview sind nachgezogen; Plan-15-Runtime-Presets, Fleet-Routing-Map und eine
  erste read-only Roles-&-Routing-UI sind verfuegbar; frische Checks: Backend 27/27, Desktop-Fokus 88/88,
